 ...
 * first by dha_license match, falling back to full_name match. Unclaimed profiles
 * (no matching dmd.users row) have no tracked user_id and correctly show zero —
 * that's an honest zero, not a bug.
 *
