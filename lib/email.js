...
// body, to prevent HTML/markup injection in the recipient's email client.
...
export async function sendContactEmail({ name, email, subject, message }) {
  ...
  const html = `
    ...
    <blockquote style="border-left:4px solid #0066FF;padding-left:16px;color:#475569">${safeMessage}</blockquote>
  `;
