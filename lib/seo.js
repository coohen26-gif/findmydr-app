...
export function pageTitle(title, isDentist = false) {
  const siteName = isDentist ? DENTIST_SITE_NAME : SITE_NAME;
  if (!title) return `${siteName} - 15 673 médecins DHA-licensés à Dubai`;
