          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="h-10 w-10 rounded-lg border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/40 hover:bg-primary-50 transition-all"
                aria-label="LinkedIn"
              >
