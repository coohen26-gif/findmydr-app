...
function getSections({ brand, domain, contactEmail, entityName }) {
  return [
    {
      id: 'legal-notice',
      icon: Building2,
      ...
      body: (
        <>
          ...
          <p>
            <strong>{brand}.ae</strong> est édité par {entityName}, société de droit émirien enregistrée à Dubai Internet City.
            Enregistrement TVA (TRN) en cours d'attribution. Siège social : Office 301, Building 16, Dubai Internet City, Dubai, UAE.
          </p>
          <p>
            Directrice de la publication : M. ({contactEmail}). Hébergeur : Hostinger International Ltd., 61 Lordou Vironos Street,
            6023 Larnaca, Chypre. Le site est hébergé sur un VPS à Dubaï.
          </p>
      ...
      body: (
        <>
          ...
          <p>
            ...
            {' '}{entityName}. En accédant à la Plateforme, vous acceptez ces CGU sans réserve.
          </p>
          ...
          <p>
            Les praticiens inscrits certifient que toutes les informations fournies sont exactes et à jour. {entityName} se réserve
          ...
          <p>
            {entityName} s'efforce de fournir des informations exactes mais ne garantit pas l'exhaustivité ou l'absence d'erreurs.
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            Le responsable du traitement est {entityName} (Dubai Internet City, UAE). Pour toute question :{' '}
            <a href={`mailto:privacy@${domain}`} className="text-primary hover:underline">privacy@{domain}</a>.
          </p>
          ...
          <p>
            Vos données sont hébergées à Dubaï et ne sont jamais vendues. Elles peuvent être partagées avec :
          </p>
          <ul>
            <li>Stripe (paiements) — données de facturation uniquement, une fois activé</li>
            <li>Brevo (emails) — email et nom pour l'envoi des magic links, une fois activé</li>
          ...
          <p>
            Pour exercer ces droits : <a href={`mailto:privacy@${domain}`} className="text-primary hover:underline">privacy@{domain}</a>.
            Réponse sous 30 jours. En cas de réclamation, vous pouvez saisir l'autorité UAE (UAE Data Office) ou la CNIL.
          </p>

          <h3>8. Sécurité</h3>
          <p>
            Vos données sont protégées par : chiffrement HTTPS/TLS, aucune donnée de mot de passe stockée (connexion par lien magique
            à usage unique envoyé par email, sans mot de passe), sessions signées par jeton JWT, limitation du taux de requêtes sur
            la connexion.
          </p>
          ...
          <p>
            ...
            une fois ces services activés, encadrés par les clauses contractuelles types de la Commission européenne.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <ul>
            ...
            <li>
              <strong>Aucun cookie de mesure d'audience actif pour le moment.</strong>
            </li>
            <li>
...
export default function Legal({ isDentist }) {
  ...
  const entityName = `${brand} FZ-LLC (exploitant findmydr.ae et findmydentist.ae)`;
  const sections = getSections({ brand, domain, contactEmail, entityName });
        ...
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <Card className="p-5 bg-muted/30">
            <p className="text-sm text-muted-foreground text-center">
              ...
              Pour toute question : <a href={`mailto:legal@${domain}`} className="text-primary font-semibold hover:underline">legal@{domain}</a>
            </p>
          </Card>
        </div>
      </section>
